...
enum {
  ...
  AGGRESSIVE,
  MAXATTITUDES,
  ATTACKSLAYONLY  // special hyperaggressive vs Slay only value for Carmen the
                  // bounty hunter
};
...
// NOTE:  The editor uses these enumerations, so please update the text as well
// if you modify or 			 add new groups.  Try to abbreviate the team name as much as
// possible.  The text is in 			 EditorMercs.c
