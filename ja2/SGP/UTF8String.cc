...
UTF8String::UTF8String(const char *utf8Encoded) : m_encoded("") {
...
const char *UTF8String::getUTF8() const { return m_encoded.c_str(); }
...
size_t UTF8String::getNumBytes() const { return m_encoded.size(); }
