...
static void LoadAndDisplayIMPText(int16_t sStartX, int16_t sStartY, int16_t sLineLength,
  ...
  // next IMP record are displayed in the specified font
  if (!fShadow) {
  ...
  LoadEncryptedDataFromFile(BINARYDATADIR "/imptext.edt", sString,
                            sIMPTextRecordNumber * IMP_SEEK_AMOUNT, IMP_SEEK_AMOUNT);
  DisplayWrappedString(sStartX, sStartY, sLineLength, 2, font, ubColor, sString, FONT_BLACK,
                       uiFlags);
...
void PrintImpText() {
  ...
  switch (iCurrentImpPage) {
    ...
    case IMP_MAIN_PAGE: {
      ...
      switch (iCurrentProfileMode) {
        case 0:
          ...
          break;
        case 1:
          DisplayWrappedString(x, y, w, 2, FONT10ARIAL, 142, pExtraIMPStrings[0], 0, 0);
          break;
        case 2:
          DisplayWrappedString(x, y, w, 2, FONT10ARIAL, 142, pExtraIMPStrings[1], 0, 0);
          break;
        case 3:
          DisplayWrappedString(x, y, w, 2, FONT10ARIAL, 142, pExtraIMPStrings[2], 0, 0);
          break;
        case 4:
          DisplayWrappedString(x, y, w, 2, FONT10ARIAL, 142, pExtraIMPStrings[3], 0, 0);
          break;
      }
      break;
    }
    ...
    case IMP_BEGIN:
      ...
      // fullname
      LoadAndDisplayIMPText(LAPTOP_SCREEN_UL_X + 81, LAPTOP_SCREEN_WEB_UL_Y + 139, 640, IMP_BEGIN_3,
                            FONT14ARIAL, FONT_BLACK, FALSE, 0);

      // nick name
      LoadAndDisplayIMPText(LAPTOP_SCREEN_UL_X + 81, LAPTOP_SCREEN_WEB_UL_Y + 199, 640, IMP_BEGIN_4,
                            FONT14ARIAL, FONT_BLACK, FALSE, 0);

      // gender
      LoadAndDisplayIMPText(LAPTOP_SCREEN_UL_X + 81, LAPTOP_SCREEN_WEB_UL_Y + 259, 640, IMP_BEGIN_6,
                            FONT14ARIAL, FONT_BLACK, FALSE, 0);
    ...
    case IMP_FINISH:
      // LoadAndDisplayIMPText(LAPTOP_SCREEN_UL_X + 160, LAPTOP_SCREEN_WEB_UL_Y +
      // 7, 640, IMP_FIN_1 - 1, FONT14ARIAL, FONT_WHITE, TRUE, 0);
    ...
    case IMP_CONFIRM:
      ...
      LoadAndDisplayIMPText(LAPTOP_SCREEN_UL_X + 160, LAPTOP_SCREEN_WEB_UL_Y + 145, 200, IMP_CON_3,
                            FONT12ARIAL, FONT_WHITE, TRUE, 0);
      break;
  }
}
...
static void OffSetQuestionForFemaleSpecificQuestions(int32_t *iCurrentOffset) {
  ...
  switch (giCurrentPersonalityQuizQuestion) {
    ...
    case 9:
      iExtraOffSet += iIMPQuestionLengths[8]; /* FALLTHROUGH */
    case 8:
      iExtraOffSet += iIMPQuestionLengths[3]; /* FALLTHROUGH */
    case 3:
      iExtraOffSet += iIMPQuestionLengths[0]; /* FALLTHROUGH */
    case 0:
      break;
