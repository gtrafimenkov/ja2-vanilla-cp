...
void RenderFuneral() {
  ...
  BltVideoObject(FRAME_BUFFER, guiMcGillicuttys, 0, FUNERAL_MCGILICUTTYS_SIGN_X,
  ...
  for (i = 0; i < FUNERAL_NUMBER_OF_LINKS; i++) {
    ...
    // Calculate the height of the string, as it needs to be vertically
    // centered.
    usStringHeight = IanWrappedStringHeight(FUNERAL_LINK_TEXT_WIDTH, 2, FUNERAL_SENTENCE_FONT,
                                            sFuneralString[i + FUNERAL_SEND_FLOWERS]);
    DisplayWrappedString(usPosX + FUNERAL_LINK_TEXT_OFFSET_X,
                         FUNERAL_LINK_1_Y + (FUNERAL_LINK_1_HEIGHT - usStringHeight) / 2,
                         FUNERAL_LINK_TEXT_WIDTH, 2, FUNERAL_SENTENCE_FONT, FUNERAL_TITLE_COLOR,
                         sFuneralString[i + FUNERAL_SEND_FLOWERS], FONT_MCOLOR_BLACK,
                         CENTER_JUSTIFIED);
...
static void DisplayFuneralRipTombStone() {
  ...
  BltVideoObject(FRAME_BUFFER, guiClosedSign, 0, FUNERAL_CLOSED_RIP_SIGN_X,
                 FUNERAL_CLOSED_RIP_SIGN_Y);
  ...
  DisplayWrappedString(FUNERAL_RIP_SENTENCE_1_X, FUNERAL_RIP_SENTENCE_1_Y,
                       ...
                       sFuneralString[FUNERAL_OUR_CONDOLENCES], FONT_MCOLOR_BLACK,
                       CENTER_JUSTIFIED);

  // sentence 11
  DisplayWrappedString(FUNERAL_RIP_SENTENCE_2_X, FUNERAL_RIP_SENTENCE_2_Y,
                       FUNERAL_RIP_SENTENCE_WIDTH, 2, FUNERAL_SMALL_FONT, FUNERAL_SENTENCE_COLOR,
                       sFuneralString[FUNERAL_OUR_SYMPATHIES], FONT_MCOLOR_BLACK, CENTER_JUSTIFIED);
