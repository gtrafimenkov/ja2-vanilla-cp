...
static BOOLEAN gfHomePageActive =
...
void EnterFlorist() {
  ...
  guiGalleryButton = CreateIconAndTextButton(
      ...
      FLORIST_BUTTON_TEXT_DOWN_COLOR, FLORIST_BUTTON_TEXT_SHADOW_COLOR, FLORIST_GALLERY_BUTTON_X,
      FLORIST_GALLERY_BUTTON_Y, MSYS_PRIORITY_HIGH, BtnGalleryButtonCallback);
...
void RenderFlorist() {
  ...
  for (i = 0; i < FLORIST_NUMBER_OF_BULLETS; i++) {
    ...
    DisplayWrappedString(FLORIST_FIRST_SENTENCE_COLUMN_TEXT_X, usPosY + 20,
    ...
    DisplayWrappedString(FLORIST_SECOND_SENTENCE_COLUMN_TEXT_X, usPosY + 15,
...
void DisplayFloristDefaults() {
  ...
  if (guiCurrentLaptopMode == LAPTOP_MODE_FLORIST) {
    ...
    BltVideoObject(FRAME_BUFFER, guiSmallTitleSymbol, 0, FLORIST_SMALL_TITLE_X,
