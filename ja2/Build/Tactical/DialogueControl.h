...
enum DialogQuoteIDs {
  ...
  QUOTE_WORK_UP_AND_RETURNING_TO_ASSIGNMENT,  // woke up from auto sleep, going
                                              // back to wo
  QUOTE_ME_TOO,  // me too quote, in agreement with whatever the merc previous
                 // said
  QUOTE_USELESS_ITEM,
...
class DialogueEventCallback : public DialogueEvent {
 public:
  bool Execute() {
    callback();
    return false;
