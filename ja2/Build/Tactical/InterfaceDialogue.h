...
struct NPC_DIALOGUE_TYPE {
  ...
  wchar_t zQuoteStr[480];  // QIALOGUE_SIZE is in dialog control which includes
                           // this file...
};
...
enum {
  ...
  NPC_ACTION_KROTT_ALIVE_LOYALTY_BOOST, /* Delayed loyalty effects elimininated.
                                           Sep.12/98.  ARM */
  ...
  NPC_ACTION_KINGPIN_GIVEN_MONEY,  // actually handled in item-acceptance code,
                                   // NPC.c
