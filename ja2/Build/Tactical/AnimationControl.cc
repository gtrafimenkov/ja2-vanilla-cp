...
const ANIMCONTROLTYPE gAnimControl[NUMANIMATIONSTATES] = {
    ...
    M("WALKING", 0, 1.6f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_VARIABLE_EFFORT, S,
      S),  // WALKING
    M("STANDING", 0, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
          ANIM_VARIABLE_EFFORT | ANIM_BREATH,
      S, S),  // Breathing
    M("KNEEL DOWN", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM |
          ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT,
      S, C),  // KNEEL DOWN
    M("CROUCHED", 0, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_RAISE_WEAPON | ANIM_NO_EFFORT |
          ANIM_BREATH,
      C, C),  // CROUCHING
    M("KNEEL UP", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM |
      ...
      C, S),  // KNEEL UP
    M("SWAT", 0, 2.2f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT, C,
      C),  // SWAT
    M("RUN", 0, 2.6f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_MODERATE_EFFORT, S,
      S),  // RUN
    M("PRONE DOWN", 100, 0.0f,
      ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM | ANIM_NOCHANGE_WEAPON |
          ANIM_MIN_EFFORT,
      C, P),  // PRONE DOWN
    M("CRAWL", 0, 0.8f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_MODERATE_EFFORT, P,
      P),  // CRAWL
    M("PRONE UP", 100, 0.0f,
      ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM | ANIM_NOCHANGE_WEAPON |
          ANIM_MIN_EFFORT,
      P, C),  // PRONE UP
    M("PRONE", 0, 0.0f,
      ANIM_STATIONARY | ANIM_FASTTURN | ANIM_RAISE_WEAPON | ANIM_NO_EFFORT | ANIM_BREATH, P,
      P),  // PRONE BREATHING
    M("READY AIM (R) STAND", 0, 0.0f,
      ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN |
          ANIM_RAISE_WEAPON | ANIM_MIN_EFFORT,
      S, S),  // READY_RIFLE_STAND
    M("AIM (R) STAND", 250, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_RAISE_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // AIM_RIFLE_STAND
    M("SHOOT (R) STAND", 100, 0.0f,
      ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT |
          ANIM_FIRE | ANIM_RT_NONINTERRUPT,
      S, S),  // SHOOT_RIFLE_STAND
    M("END RIFLE STAND", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_NOCHANGE_PENDINGCOUNT |
          ANIM_MIN_EFFORT,
      S, S),  // END_RIFLE_STAND
    M("CROUCH TO SWAT", 40, 1.3f, ANIM_MOVING | ANIM_TURNING | ANIM_LIGHT_EFFORT, C,
      C),  // FROM CROUCH TO SWAT
    M("SWAT TO CROUCH", 40, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT, C,
      C),  // FROM SWAT TO CROUCH
    M("FLYBACK HIT", 80, 1.6f,
      ANIM_SPECIALMOVE | ANIM_HITSTART | ANIM_HITFINISH | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      S, P),  // FLYBACK HIT ANIMATION
    M("READY (R) PRONE", 150, 0.0f,
      ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING |
          ANIM_RAISE_WEAPON | ANIM_MIN_EFFORT,
      P, P),  // READY_RIFLE_PRONE
    M("AIM (R) PRONE", 250, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_RAISE_WEAPON |
          ANIM_LIGHT_EFFORT,
      P, P),  // AIM_RIFLE_PRONE
    M("SHOOT (R) PRONE", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE |
          ANIM_RT_NONINTERRUPT,
      P, P),  // SHOOT_RIFLE_PRONE
    M("END (R) AIM PRONE", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_NOCHANGE_PENDINGCOUNT |
          ANIM_MIN_EFFORT,
      P, P),  // END_RIFLE_PRONE
    M("DEATH TWITCH ONE", 100, 0.0f,
      ANIM_STATIONARY | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // DEATH TWITCH ONE
    M("GENERIC HIT STAND", 130, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTART | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      S, S),  // GENERIC_HIT STANDING
    M("FLYBACK HIT w/B", 80, 1.6f,
      ANIM_SPECIALMOVE | ANIM_HITSTART | ANIM_HITFINISH | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      P, P),  // FLYBACK HIT ANIMATION W/ BLOOD
    M("FLYBACK HIT DEATH", 120, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // FLYBACK HIT DEATH
    M("READY (R) CROUCH", 150, 0.0f,
      ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING |
          ANIM_RAISE_WEAPON | ANIM_MIN_EFFORT,
      C, C),  // READY_RIFLE_CROUCH
    M("AIM (R) CROUCH", 250, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_RAISE_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // AIM_RIFLE_CROUCH
    M("SHOOT (R) CROUCH", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE |
          ANIM_RT_NONINTERRUPT,
      C, C),  // SHOOT_RIFLE_CROUCH
    M("END (R) CROUCH", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_NOCHANGE_PENDINGCOUNT |
          ANIM_MIN_EFFORT,
      C, C),  // END_RIFLE_CROUCH
    M("FALLBACK HIT STAND", 130, 1.6f,
      ANIM_SPECIALMOVE | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      S, P),  // FALLBACK HIT STANDING
    M("ROOLOVER", 100, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      P,
      P),  // ROLLOVER
    M("CLIMBROOF", 30, 0.0f,
      ANIM_NONINTERRUPT | ANIM_NORESTART | ANIM_STATIONARY | ANIM_NOSHOW_MARKER |
          ANIM_MODERATE_EFFORT | ANIM_LOWER_WEAPON,
      S, C),  // CLIMBROOF
    M("FALL", 60, 0.0f,
      ANIM_NONINTERRUPT | ANIM_STATIONARY | ANIM_HITFINISH | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      S, P),  // FALL
    M("GETUP FROM ROLLOVER", 100, 0.0f, ANIM_STATIONARY | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      S),  // GETUP FROM ROLLOVER
    M("CLIMBDOWNROOF", 30, 0.0f,
      ANIM_NONINTERRUPT | ANIM_NORESTART | ANIM_STATIONARY | ANIM_NOSHOW_MARKER |
          ANIM_MODERATE_EFFORT | ANIM_LOWER_WEAPON,
      C, S),  // CLIMBDOWNROOF
    M("FALL FORWARD ROOF", 60, 0.0f,
      ANIM_NONINTERRUPT | ANIM_STATIONARY | ANIM_HITFINISH | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      S, P),  // FALL FORWARD
    M("BELLY DEATHHIT NB", 100, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // GENERIC HIT DEATHTWICH NO BLOOD
    M("BELLY DEATHHIT B", 100, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // GENERIC HIT DEATHTWICH BLOOD
    M("FALLBACK DEATHHIT NB", 100, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // FALLBACK HIT DEATHTWICH NO BLOOD
    M("FALLBACK DEATHHIT B", 100, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // FALLBACK HIT DEATHTWICH BLOOD
    M("BELLY HIT DEATH", 120, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // GENERIC HIT DEATH
    M("FALLBACK HIT DEATH", 120, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // FALLBACK HIT DEATH
    M("GENERIC HIT CROUCH", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      C, C),  // GENERIC HIT CROUCHED
    M("STAND BURST SHOOT", 100, 0.0f,
      ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_FIRE,
      S, S),  // STAND BURST
    M("STAND BUTST HIT", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON |
          ANIM_IGNORE_AUTOSTANCE,
      S, S),  // STANDING BURST HIT
    M("FALL FROM STAND", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // FALL FORWARD FROM HIT STAND
    M("FALL FROM CROUCH", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      C, P),  // FALL FORWARD FROM HIT CROUCH
    M("END FALL F CROUCH", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // END FALL FORWARD FROM HIT CROUCH
    M("GENERIC HIT PRONE", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // GENERIC HIT PRONE
    M("PRONE HIT DEATH", 120, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // PRONE HIT DEATH
    M("PRONE LAY FROM HIT", 160, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // PRONE LAY FROM HIT
    M("PRONE DEATHHIT NB", 100, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // PRONE HIT DEATHTWICH NO BLOOD
    M("PRONE DEATHHIT B", 100, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // PRONE HIT DEATHTWICH BLOOD
    M("FEMADMON BREATHING", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // FEMALE MONSTER BREATHING
    M("FEMADMON WALKING", 30, 2.5f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // FEMALE MONSTER BREATHING
    M("FEMADMON ATTACK", 70, 2.5f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // FEMALE MONSTER ATTACK
    M("FLYBACK HIT DEATH STOP", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("BELLY HIT DEATH STOP", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("FALLBACK HIT DEATH STOP", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("PRONE HIT DEATH STOP", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("FLYBACK HIT STOP", 70, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("FALLBACK HIT STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("FALLOFF STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("FALLOFF FORWARD HIT STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("FALLFORWARD HIT STOP", 650, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("PRONE_LAYFROMHIT STOP", 70, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P, P),
    M("HOP FENCE", 50, 0.0f,
      ANIM_NOCHANGE_PENDINGCOUNT | ANIM_NORESTART | ANIM_STATIONARY | ANIM_NOSHOW_MARKER |
          ANIM_MODERATE_EFFORT | ANIM_LOWER_WEAPON | ANIM_NONINTERRUPT,
      S, C),
    M("FEMMONS HIT", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // GENERIC HIT CROUCHED
    M("FEMMONS DIE", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // FALL FORWARD FROM HIT STAND
    M("FEMMONS DIE STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // FALL FORWARD FROM HIT STAND
    M("PUNCH BREATH", 150, 0.0f,
      ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART |
          ANIM_FIREREADY | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, S),  // Breathing
    M("PUNCH", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NORESTART, S,
      S),  // Punch
    M("NOTHING_STAND", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // Breathing
    M("JFK HIT DEATH", 160, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_HITSTART | ANIM_HITFINISH | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, P),  // JFK HIT DEATH
    M("JFK HIT DEATH STOP", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      P, P),
    M("JFK DEATHHIT B", 100, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),
    M("STAND BURST SPREAD", 100, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT, S,
      S),  // STAND BURST
    M("FALLOFF DEATH", 120, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // FALLOFF DEATH
    M("FALLOFF DEATH STOP", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // FALLOFF DEATH STOP
    M("FALLOFF TWITCH BLOOD", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // FALLOFF TWITCHB
    M("FALLOFF TWITCH NOBLOOD", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // FALLOFF TWITCH NB
    M("FALLOFF FORWARD DEATH", 120, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // FALLOFF FORWARD DEATH
    M("FALLOFF FORWARD DEATH STOP", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // FALLOFF FORWARD DEATH STOP
    M("FALLOFF FORWARD TWITCH BLOOD", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // FALLOFF FORWARD TWITCHB
    M("FALLOFF FORWARD TWITCH NOBLOOD", 120, 0.0f,
      ANIM_STATIONARY | ANIM_HITWHENDOWN | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      P, P),  // FALLOFF TWITCH NB
    M("OPEN DOOR", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // OPEN DOOR
    M("OPEN STRUCT", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // OPEN STRUCT
    M("PICKUP ITEM", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // OPEN STRUCT
    M("DROP ITEM", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // DROP ITEM
    M("SLICE", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT, S,
      S),  // SLICE
    M("STAB", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT, S,
      S),  // STAB
    M("CROUCH STAB", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT, C,
      C),  // CROUCH STAB
    M("START AID", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      C, C),  // START GIVING AID
    M("GIVING AID", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT, C,
      C),  // GIVING AID
    M("END AID", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_PENDINGCOUNT,
      C, C),  // END GIVING AID
    M("DODGE ONE", 40, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // DODGE ONE
    M("FATCIV ASS SCRATCH", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NO_EFFORT, S,
      S),  // FATCIV_ASSSCRATCH
    M("READY AIM (DW) STAND", 150, 0.0f,
      ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN |
          ANIM_LIGHT_EFFORT,
      S, S),  // READY_RIFLE_STAND
    M("AIM (DW) STAND", 250, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_LIGHT_EFFORT, S,
      S),  // AIM_RIFLE_STAND
    M("SHOOT (DW) STAND", 150, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE,
      S,
      S),  // SHOOT_RIFLE_STAND
    M("END DUAL STAND", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_PENDINGCOUNT | ANIM_LIGHT_EFFORT, S,
      S),  // END_RIFLE_STAND
    M("RAISE RIFLE", 70, 0.0f,
      ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S,
      S),  // RAISE RIFLE
    M("LOWER RIFLE", 70, 0.0f,
      ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S,
      S),  // LOWER RIFLE
    M("BOD BLOW", 200, 0.0f,
      ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NO_EFFORT | ANIM_NONINTERRUPT |
          ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      S, S),  // BOD BLOW
    M("THROW ITEM", 80, 0.0f,
      ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT, S,
      S),  // THROW ITEM
    M("LOB ITEM", 80, 0.0f,
      ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT, S,
      S),  // LOB ITEM
    M("MONSTER_STATIONARY", 100, 0.0f,
      ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NO_EFFORT | ANIM_BREATH, S,
      S),  // QUEEN MONSTER STATIONARY
    M("CROUCHED BURST SHOOT", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE, C,
      C),  // CROUCHED BURST
    M("PRONE BURST SHOOT", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE, P,
      P),  // PRONE BURST
    M("NOT USED 1", 20, 0.9f, ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, S,
      S),  // 180
    M("BIG GUY FLEX", 150, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NO_EFFORT, S,
      S),  // BIG GUY FLEX
    M("BIG GUY STRECH", 110, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NO_EFFORT,
      S,
      S),  // BIG GUY STRECH
    M("BIG GUY SHOE DUST", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S,
      S),  // BIG GUY SOEDUST
    M("BIG GUY HEAD TURN", 180, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S,
      S),  // BIG GUY HEADTURN
    M("MINI GIRL STOCKING", 120, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT, S,
      S),  // MINI GIRL STOCKING
    M("GIVE ITEM", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // GIVE ITEM
    M("CLIMB MOUNTAIN", 50, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NOSHOW_MARKER |
          ANIM_MODERATE_EFFORT,
      S, C),  // CLIMB MOUNTIAIN
    M("COW EATING", 200, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT, S, S),
    M("COW HIT", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT, S,
      S),  // COW HIT
    M("COW DIE", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT,
      S, P),  // COW DIE
    M("COW DIE STOP", 350, 0.0f, ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT, P,
      P),  // COW DIE STOP
    M("WATER HIT", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // WATER HIT
    M("WATER DIE", 160, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // WATER DIE
    M("WATER DIE STOP", 340, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // WATER DIE STOP
    ...
    M("CROW FLY", 20, 0.5f,
      ANIM_SPECIALMOVE | ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT, S, S),
    M("CROW EAT", 80, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_MIN_EFFORT, S,
      S),
    M("HELIDROP", 60, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT, S, C),
    M("FEM CLEAN", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("FEM KICKSN", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("FEM LOOK", 180, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("FEM WIPE", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("REG SQUISH", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("REG PULL", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("REG SPIT", 130, 0.0f,
    ...
    M("ADULT MONSTER CLOSE ATTACK", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),
    M("ADULT MONSTER SPIT ATTACK", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),
    M("ADULT MONSTER BEGIN EATING", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT, S, S),
    M("ADULT MONSTER EATING", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT, S, S),
    M("ADULT MONSTER END EATING", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT, S, S),
    M("BLOODCAT RUN", 50, 5.4f, ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_MODERATE_EFFORT,
      S,
      S),  // RUN
    M("BLOODCAT BEGIN READY", 70, 0.0f,
      ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT,
      S, S),  //
    M("BLOODCAT READY", 130, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT,
      S, S),
    M("BLOODCAT END READY", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, S, S),
    M("BLOODCAT HIT", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT, S,
      S),  // CAT HIT
    M("BLOODCAT DIE", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER, S,
      P),  // CAT DIE
    M("BLOODCAT DIE STOP", 100, 0.0f, ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT, P,
      P),  // CAT DIE STOP
    M("BLOODCAT SWIPE", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT, S, S),
    M("NINJA GOTO BREATH", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, S),
    M("NINJA BREATH", 0, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, S, S),
    M("NINJA LOWKICK", 50, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_NORESTART,
      S, S),
    M("NINJA PUNCH", 50, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_NORESTART,
      S, S),
    M("NINJA SPIN KICK", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_MODERATE_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_NORESTART,
      S, S),
    M("END OPEN DOOR", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_MIN_EFFORT,
      S, S),  // END OPEN DOOR
    M("END OPEN LOCKED DOOR", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_MIN_EFFORT,
      S, S),  // END OPEN LOCKED DOOR
    M("KICK DOOR", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // KICK DOOR
    M("CLOSE DOOR", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_MIN_EFFORT,
      S, S),  // KICK DOOR
    M("HIT STAND RIFLE", 150, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTART | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_NOCHANGE_WEAPON |
          ANIM_NO_EFFORT,
      S, S),  // HIT STANDING RIFLE
    M("DEEP WATER TREAD", 200, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_WEAPON | ANIM_MODERATE_EFFORT, S,
      S),  // DEEP WATER TREAD
    M("DEEP WATER SWIM", 160, 1.3f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_NOCHANGE_WEAPON | ANIM_MODERATE_EFFORT, S,
      S),  // DEEP WATER SWIM
    M("DEEP WATER HIT", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT, S,
      S),  // DEEP WATER HIT
    M("DEEP WATER DIE", 210, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // DEEP WATER DIE
    M("DEEP WATER DIE STOPPING", 340, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // DEEP WATER DIE STOPPING
    M("DEEP WATER DIE STOP", 340, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // DEEP WATER DIE STOP
    M("LOW TO DEEP WATER", 100, 0.0f, ANIM_STATIONARY | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S,
      S),  // WATER TRANSITION
    M("DEEP TO LOW WATER", 100, 0.0f, ANIM_STATIONARY | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S,
      S),  // WATER TRANSITION
    M("GOTO SLEEP", 100, 0.0f,
      ANIM_STATIONARY | ANIM_LOWER_WEAPON | ANIM_NONINTERRUPT | ANIM_NO_EFFORT, C,
      P),  // GOTO SLEEP
    M("SLEEPING", 2000, 0.0f, ANIM_STATIONARY | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, P,
      P),                                                                                // SLEEP
    M("WAKEUP", 100, 0.0f, ANIM_STATIONARY | ANIM_RAISE_WEAPON | ANIM_NO_EFFORT, P, C),  // WAKEUP
    M("SHOOT (R) STAND LOW", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, S,
      S),  // SHOOT_RIFLE_STAND LOW
    M("BURST SHOOT (R) STAND LOW", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, S,
      S),  // SHOOT_RIFLE_STAND LOW
    M("LARVAE BREATH", 250, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // LARVAE Breathing
    M("LARVAE HIT", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // GENERIC HIT CROUCHED
    M("LARVAE DIE", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // FALL FORWARD FROM HIT STAND
    M("LARVAE DIE STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // FALL FORWARD FROM HIT STAND
    M("LARVAE WALKING", 110, 0.5f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // FEMALE MONSTER BREATHING
    M("INFANT HIT", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // GENERIC HIT CROUCHED
    M("INFANT DIE", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // FALL FORWARD FROM HIT STAND
    M("INFANT DIE STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // FALL FORWARD FROM HIT STAND
    M("INFANT MONSTER SPIT ATTACK", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),
    M("INFANT MONSTER BEGIN EATING", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),
    M("INFANT MONSTER EATING", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),
    M("INFANT MONSTER END EATING", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),
    M("ADULT  MONSTER UP", 130, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),
    M("ADULT  MONSTER JUMP", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),
    M("UNJAM STANDING", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT, S,
      S),  // UNJAM STANDING
    M("UNJAM CROUCH", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT, C,
      C),  // UNJAM CROUCH
    M("UNJAM PRONE", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT, P,
      P),  // UNJAM PRONE
    M("UNJAM STAND DWEL", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT, S,
      S),  // UNJAM STAND DWEL
    M("UNJAM STAND LOW", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT, S,
      S),  // UNJAM STAND LOW
    M("READY AIM (DW) CROUCH", 150, 0.0f,
      ANIM_OK_CHARGE_AP_FOR_TURN | ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN |
          ANIM_LIGHT_EFFORT,
      C, C),  // READY_RIFLE_CROUCH
    M("AIM (DW) CROUCH", 250, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_LIGHT_EFFORT, C,
      C),  // AIM_RIFLE_CROUCH
    M("SHOOT (DW) CROUCH", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE, C,
      C),  // SHOOT_RIFLE_CROUCH
    M("END DUAL CROUCH", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_PENDINGCOUNT | ANIM_LIGHT_EFFORT, C,
      C),  // END_RIFLE_STAND
    M("UNJAM CROUCH DWEL", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT, C,
      C),  // UNJAM CROUCH DWEL
    M("GET ADJACENT ITEM", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // GET ADJACENT ITEM
    M("CUTTING FENCE", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      C, C),  // CUTTING FENCE
    M("CRIPPLE BEG", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("CRIPPLE HIT", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NONINTERRUPT | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // CRIPPLE HIT
    M("CRIPPLE DIE", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // CRIPPLE DIE
    M("CRIPPLE DIE STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // CRIPPLE DIE STOP
    M("CRIPPLE FLYBACK DIE", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // CRIPPLE FLYBACK DIE
    M("CRIPPLE FLYBACK DIE STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // CRIPPLE FLYBACK DIE STOP
    M("CRIPPLE KICK", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_NOMOVE_MARKER | ANIM_MIN_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // CRIPPLE KICK
    M("INJURED TRANSITION", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_NOMOVE_MARKER | ANIM_MIN_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // INJURED TRANSITION
    M("THROW KNIFE", 50, 0.0f,
      ANIM_STATIONARY | ANIM_NOMOVE_MARKER | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT, S,
      S),  // THROW KNIFE
    M("KNIFE BREATH", 150, 0.0f,
      ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART |
          ANIM_FIREREADY | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, S),  // Breathing
    M("KNIFE GOTO BREATH", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
          ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NONINTERRUPT,
      S, S),  // Breathing
    M("KNIFE END BREATH", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
          ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NONINTERRUPT,
      S, S),  // Breathing
    M("ROBOT HIT", 80, 0.0f,
    ...
    M("ROBOT DIE", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // ROBOT DIE
    M("ROBOT DIE STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // ROBOT DIE STOP
    M("Catch Standing", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
          ANIM_LIGHT_EFFORT | ANIM_LOWER_WEAPON,
      S, S),  // Catch Standing
    M("Catch Crouched", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
          ANIM_LIGHT_EFFORT | ANIM_LOWER_WEAPON,
      C, C),  // Catch Crouched
    M("PLANT BOMB", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // PLANT BOMB
    M("Use Remote", 80, 0.0f,
      ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART |
          ANIM_FIREREADY | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NONINTERRUPT,
      S, S),  // Use remote
    M("START Cower", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
          ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NONINTERRUPT | ANIM_IGNORE_AUTOSTANCE,
      S, C),  // COWER
    M("Cowering", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
          ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      C, C),  // COWER
    M("End Cower", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
          ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      C, S),  // END COWER
    M("STEAL ITEM", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // STEAL ITEM
    M("LAUNCH ROCKET", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT, S,
      S),  // LAUNCH ROCKET
    M("CIV ALT DIE", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, P),  // CIV ALT DIE
    M("SHOOT MORTAR", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // SHOOT MORTAR
    M("CROW_DIE", 130, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NOCHANGE_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // CROW DIE
    M("SIDE STEPPING", 50, 0.4f,
      ANIM_MOVING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_VARIABLE_EFFORT, S,
      S),  // SIDE STEPPING
    M("WALK BACKWARDS", 110, 1.4f,
      ANIM_MOVING | ANIM_NORESTART | ANIM_RAISE_WEAPON | ANIM_VARIABLE_EFFORT | ANIM_TURNING, S,
      S),  // WALK BACKWARDS
    M("BEGIN OPEN STRUCT", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      S, S),  // OPEN STRUCT
    M("END OPEN STRUCT", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      S, S),  // END STRUCT
    M("END OPEN LOCKED STRUCT", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      S, S),  // END OPEN LOCKED
    M("LOW PUNCH", 70, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      C,
      C),  // Punch LOw
    M("SHOOT (P) STAND LOW", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, S,
      S),  // SHOOT_PISTOL_STAND LOW
    M("DECAPITATE", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT |
          ANIM_NONINTERRUPT,
      C, C),  // DECAPITATE
    M("BLOODCAT BITE", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_MIN_EFFORT, S, S),
    M("BIGMERC S NECK", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("BIGMERC CROUCH TRANS INTO", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM |
          ANIM_RAISE_WEAPON | ANIM_MIN_EFFORT,
      S, C),  // CROUCH TRANSITION
    M("BIGMERC CROUCH TRANS OUTOF", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_STANCECHANGEANIM |
          ANIM_RAISE_WEAPON | ANIM_MIN_EFFORT,
      C, S),  // CROUCH TRANSITION
    M("GOTO PATIENT", 1000, 0.0f,
      ANIM_STATIONARY | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, P,
      P),  // GOTO PATIENT
    M("BEING PATIENT", 1000, 0.0f,
      ANIM_STATIONARY | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, P,
      P),  // BEING PATIENT
    M("GOTO DOCTOR", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      C, C),  // GOTO DOCTOR
    M("BEING DOCTOR", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT, C,
      C),  // BEING DOCTOR
    M("END DOCTOR", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_PENDINGCOUNT,
      C, C),  // ENDING DOCTOR
    M("GOTO REPAIRMAN", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      C, C),  // GOTO REPAIRMAN
    M("BEING REPAIRMAN", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT, C,
      C),  // BEING REPAIRMAN
    M("END REPAIRMAN", 90, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_PENDINGCOUNT,
      C, C),  // ENDING REPAIRMAN
    M("FALL INTO PIT", 60, 0.0f,
      ANIM_STATIONARY | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, P),  // FALL INTO PIT
    M("ROBOT WALKING", 80, 1.5f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // ROBOT WALK
    M("ROBOT SHOOT", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, S,
      S),  // ROBOT SHOOT
    M("QUEEN HIT", 200, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITSTART | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // QUEEN HIT
    M("QUEEN DIE", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_HITFINISH | ANIM_NOMOVE_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, P),  // QUEEN DIE
    M("QUEEN DIE STOP", 350, 0.0f,
      ANIM_STATIONARY | ANIM_HITSTOP | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON, P,
      P),  // QUEEN DIE STOP
    M("QUEEN INTO READY", 130, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, S, S),
    M("QUEEN READY", 130, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, S,
      S),
    M("QUEEN END READY", 130, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, S, S),
    M("QUEEN CALL", 130, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, S,
      S),
    M("QUEEN MONSTER SPIT ATTACK", 130, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),
    M("QUEEN MONSTER SWIPE ATTACK", 130, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NONINTERRUPT | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),
    M("RELOAD ROBOT", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      C, C),  // RELOAD ROBOT
    M("Catch Standing", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
          ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NONINTERRUPT,
      S, S),  // End Catch Standing
    M("Catch Crouched", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_FIREREADY |
          ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NONINTERRUPT,
      C, C),  // End Catch Crouched
    M("RADIO", 130, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT, S, S),
    M("CROUCH RADIO", 130, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_NORESTART | ANIM_NO_EFFORT,
      C, C),
    M("TANK SHOOT", 200, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, S,
      S),  // TANK SHOOT
    M("TANK BURST", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_FIRE, S,
      S),  // TANK SHOOT
    M("QUEEN SLAP", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // Queen Slap
    M("SLAP HIT", 70, 0.0f,
    ...
    M("GET BLOOD", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      C, C),  // GET BLOOD
    M("VEHICLE DIE", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_NOCHANGE_WEAPON | ANIM_LIGHT_EFFORT,
      S, S),  // VEHICLE DIE
    M("QUEEN FRUSTRATED SLAP", 120, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON,
      S, S),  // Queen Frustrated Slap
    M("FIRE FIRE", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_NOCHANGE_WEAPON | ANIM_LIGHT_EFFORT | ANIM_IGNORE_AUTOSTANCE,
      S, S),  // SOLDIER BRUN
    M("AI TRIGGER", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // AI TRIGGER
    M("MONSTERMELT", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NONINTERRUPT | ANIM_HITFINISH | ANIM_NOMOVE_MARKER |
          ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON,
      P, P),  // MONSTER MELT
    M("MERC INJURED IDLE ANIM", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("END INJURED WALK", 80, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOMOVE_MARKER | ANIM_MIN_EFFORT | ANIM_NOCHANGE_WEAPON,
      S, S),  // INJURED TRANSITION
    M("PASS OBJECT", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // PASS OBJECT
    M("ADJACENT DROP OBJECT", 110, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // ADJACENT DROP OBJECT
    M("READY AIM (DW) PRONE", 150, 0.0f,
      ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_LIGHT_EFFORT, P,
      P),  // READY_RIFLE_PRONE
    M("AIM (DW) PRONE", 250, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FIREREADY | ANIM_FASTTURN | ANIM_LIGHT_EFFORT, P,
      P),  // AIM_RIFLE_PRONE
    M("SHOOT (DW) PRONE", 150, 0.0f, ANIM_STATIONARY | ANIM_TURNING | ANIM_LIGHT_EFFORT | ANIM_FIRE,
      P,
      P),  // SHOOT_RIFLE_PRONE
    M("END DUAL PRONE", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NOCHANGE_PENDINGCOUNT | ANIM_LIGHT_EFFORT, P,
      P),  // END_RIFLE_PRONE
    M("UNJAM PRONE DWEL", 150, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NOCHANGE_WEAPON | ANIM_MIN_EFFORT, P,
      P),  // UNJAM PRONE DWEL
    M("PICK LOCK", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      S, S),  // PICK LOCK
    M("OPEN DOOR CROUCHED", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // OPEN DOOR CROUCHED
    M("BEGIN OPEN STRUCT CROUCHED", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // BEGIN OPENSTRUCT CROUCHED
    M("CLOSE DOOR CROUCHED", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // CLOSE DOOR CROUCHED
    M("OPEN STRUCT CROUCHED", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // OPEN STRUCT CROUCHED
    M("END OPEN DOOR CROUCHED", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // END OPEN DOOR CROUCHED
    M("END OPENSTRUCT CROUCHED", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // END OPENSTRUCT CROUCHED
    M("END OPNE LOCKED DOOR CR", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // END OPEN LOCKED DOOR CROUCHED
    M("END OPEN STRUCT LOCKED CR", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C),  // END OPEN STRUCT LOCKED CR
    M("DRUNK IDLE", 170, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_MERCIDLE | ANIM_NOCHANGE_WEAPON | ANIM_NO_EFFORT, S, S),
    M("CROWBAR", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_NO_EFFORT | ANIM_NOCHANGE_WEAPON | ANIM_NORESTART, S,
      S),  // CROWBAR
    M("COWER HIT", 80, 1.6f,
      ANIM_HITSTART | ANIM_HITFINISH | ANIM_NONINTERRUPT | ANIM_NOSHOW_MARKER | ANIM_NO_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_IGNORE_AUTOSTANCE,
      C, C),  // COWER HIT ANIMATION
    M("BLOODCAT WALKING BACKWARDS", 30, 1.2f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // BLOODCAT WALK BACKWARDS
    M("MONSTER WALKING BACKWARDS", 30, 2.5f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // CREATURE WALK BACKWARDS
    M("KID SKIPPING", 70, 2.0f,
      ANIM_MOVING | ANIM_TURNING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_NOCHANGE_WEAPON, S,
      S),  // KID SKIPPING
    M("STAND BURST SHOOT", 100, 0.0f,
      ANIM_NORESTART | ANIM_STATIONARY | ANIM_TURNING | ANIM_RAISE_WEAPON | ANIM_LIGHT_EFFORT |
          ANIM_NOCHANGE_WEAPON | ANIM_FIRE,
      S, S),  // STAND BURST
    M("Attach String", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      C, C),  // Attach string
    M("SWAT BACKWARDS", 110, 1.4f, ANIM_MOVING | ANIM_NORESTART | ANIM_LIGHT_EFFORT | ANIM_TURNING,
      C,
      C),  // SWAT BACKWARDS
    M("JUMP OVER", 110, 3.6f,
      ANIM_SPECIALMOVE | ANIM_NORESTART | ANIM_LOWER_WEAPON | ANIM_MODERATE_EFFORT | ANIM_TURNING,
      S, S),  // JUMP OVER BLOCKING PERSON
    M("REFUEL VEHICLE", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_LOWER_WEAPON | ANIM_LIGHT_EFFORT,
      C, C),  // REFUEL VEHICLE
    M("ROBOT CAMERA", 0, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_RAISE_WEAPON |
          ANIM_VARIABLE_EFFORT | ANIM_BREATH,
      S, S),  // Robot camera not moving
    M("CRIPPLE OPEN DOOR", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LIGHT_EFFORT, S,
      S),  // CRIPPLE OPEN DOOR
    M("CRIPPLE CLOSE DOOR", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_MIN_EFFORT, S,
      S),  // CRIPPLE CLOSE DOOR
    M("END OPEN DOOR", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_MIN_EFFORT, S,
      S),  // CRIPPLE END OPEN DOOR
    M("END OPEN LOCKED DOOR", 100, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_NONINTERRUPT |
          ANIM_MIN_EFFORT,
      S, S),  // CRIPPLE END OPEN LOCKED DOOR
    M("CROUCH PICK LOCK", 70, 0.0f,
      ANIM_STATIONARY | ANIM_TURNING | ANIM_FASTTURN | ANIM_NORESTART | ANIM_LOWER_WEAPON |
          ANIM_LIGHT_EFFORT,
      C, C)  // CROUCH PICK LOCK
};
...
// Really only the first mercs are using any of these values....
static const ANI_SPEED_DEF
    gubAnimCrawlingSpeeds[TOTALBODYTYPES] =  // XXX TODO0011 unused, should
                                             // probably be gubAnimCrawlSpeeds[]
    {
        {0, 0.8f},   // REGMALE
        {20, 0.8f},  // BIGMALE
        {0, 0.8f},   // STOCKYMALE
...
static const ANIMSUBTYPE gNothingInjuredSub = {
    WALKING, {RGMHURTWALKINGN, BGMHURTWALKINGN, RGMHURTWALKINGN, RGFHURTWALKINGN}};
static const ANIMSUBTYPE gDoubleHandledSub = {
  ...
  switch (s->ubBodyType) {
    case QUEENMONSTER:
      switch (anim_state) {
        ...
        case WALKING:
        case RUNNING:
          return QUEEN_MONSTER_BREATHING;
      }
      break;
...
char const *GetBodyTypePaletteSubstitution(SOLDIERTYPE const *const s, uint8_t const ubBodyType) {
  switch (ubBodyType) {
    ...
    case REGFEMALE:
      if (s) {
        // Are we on fire?
        if (s->usAnimState == CHARIOTS_OF_FIRE || s->usAnimState == BODYEXPLODING) {
          return "";
        }
    ...
    case YAF_MONSTER:
      return ANIMSDIR "/MONSTERS/fm_brite.COL";
    case YAM_MONSTER:
      return ANIMSDIR "/MONSTERS/mn_brite.COL";
    case ADULTFEMALEMONSTER:
      return ANIMSDIR "/MONSTERS/femmon.COL";
    case AM_MONSTER:
      return ANIMSDIR "/MONSTERS/monster.COL";
...
uint16_t DetermineSoldierAnimationSurface(const SOLDIERTYPE *pSoldier, uint16_t usAnimState) {
  ...
  if (usAnimSurface == INVALID_ANIMATION) {
    ...
    ScreenMsg(FONT_MCOLOR_RED, MSG_BETAVERSION,
              L"Invalid Animation File for Body %d, animation %hs.", pSoldier->ubBodyType,
  ...
  if (MercInWater(pSoldier)) {
    ...
    usAltAnimSurface =
        gubAnimSurfaceMidWaterSubIndex[pSoldier->ubBodyType][usAnimState][ubWaterHandIndex];
    ...
    // Based on if we have adjusted for item or not... check for injured
    // status...
    if (fAdjustedForItem) {
...
uint16_t GetSoldierAnimationSurface(SOLDIERTYPE const *const pSoldier) {
  ...
  if (usAnimSurface != INVALID_ANIMATION_SURFACE) {
    ...
    if (gAnimSurfaceDatabase[usAnimSurface].hVideoObject == NULL) {
      ScreenMsg(FONT_MCOLOR_RED, MSG_BETAVERSION,
                L"IAnimation Surface for Body %d, animation %hs, surface %d "
                L"not loaded.",
...
TEST(AnimationControl, asserts) { EXPECT_EQ(lengthof(gAnimControl), NUMANIMATIONSTATES); }
