...
// Ensures a good path.....
UINT16 FindGridNoFromSweetSpotThroughPeople(const SOLDIERTYPE *pSoldier, INT16 sSweetGridNo,
                                            INT8 ubRadius);

// Returns a good sweetspot but not the swetspot!
UINT16 FindGridNoFromSweetSpotExcludingSweetSpot(const SOLDIERTYPE *pSoldier, INT16 sSweetGridNo,
                                                 INT8 ubRadius);

UINT16 FindGridNoFromSweetSpotExcludingSweetSpotInQuardent(const SOLDIERTYPE *pSoldier,
                                                           INT16 sSweetGridNo, INT8 ubRadius,
                                                           INT8 ubQuardentDir);

// Finds a gridno near a sweetspot but a random one!
UINT16 FindRandomGridNoFromSweetSpot(const SOLDIERTYPE *pSoldier, INT16 sSweetGridNo,
                                     INT8 ubRadius);
...
void AddSoldierToSectorNoCalculateDirectionUseAnimation(SOLDIERTYPE *, UINT16 usAnimState,
                                                        UINT16 usAnimCode);
...
UINT16 FindGridNoFromSweetSpotWithStructDataFromSoldier(const SOLDIERTYPE *pSoldier,
