  ...
  switch (z) {
    case 0:
      ...
      switch (SectorInfo[sector_id].ubTraversability[THROUGH_STRATEGIC_MOVE]) {
        case TOWN:
          return Random(2) == 0 ? (night ? LOADINGSCREEN_NIGHTTOWN1 : LOADINGSCREEN_DAYTOWN1)
...
void DisplayLoadScreenWithID(LoadingScreenID const id) {
  ...
  switch (id) {
    case LOADINGSCREEN_NOTHING:
      filename = LOADSCREENSDIR "/ls_heli.sti";
      break;
    case LOADINGSCREEN_DAYGENERIC:
      filename = LOADSCREENSDIR "/ls_daygeneric.sti";
      break;
    case LOADINGSCREEN_DAYTOWN1:
      filename = LOADSCREENSDIR "/ls_daytown1.sti";
      break;
    case LOADINGSCREEN_DAYTOWN2:
      filename = LOADSCREENSDIR "/ls_daytown2.sti";
      break;
    case LOADINGSCREEN_DAYWILD:
      filename = LOADSCREENSDIR "/ls_daywild.sti";
      break;
    case LOADINGSCREEN_DAYTROPICAL:
      filename = LOADSCREENSDIR "/ls_daytropical.sti";
      break;
    case LOADINGSCREEN_DAYFOREST:
      filename = LOADSCREENSDIR "/ls_dayforest.sti";
      break;
    case LOADINGSCREEN_DAYDESERT:
      filename = LOADSCREENSDIR "/ls_daydesert.sti";
      break;
    case LOADINGSCREEN_DAYPALACE:
      filename = LOADSCREENSDIR "/ls_daypalace.sti";
      break;
    case LOADINGSCREEN_NIGHTGENERIC:
      filename = LOADSCREENSDIR "/ls_nightgeneric.sti";
      break;
    case LOADINGSCREEN_NIGHTWILD:
      filename = LOADSCREENSDIR "/ls_nightwild.sti";
      break;
    case LOADINGSCREEN_NIGHTTOWN1:
      filename = LOADSCREENSDIR "/ls_nighttown1.sti";
      break;
    case LOADINGSCREEN_NIGHTTOWN2:
      filename = LOADSCREENSDIR "/ls_nighttown2.sti";
      break;
    case LOADINGSCREEN_NIGHTFOREST:
      filename = LOADSCREENSDIR "/ls_nightforest.sti";
      break;
    case LOADINGSCREEN_NIGHTTROPICAL:
      filename = LOADSCREENSDIR "/ls_nighttropical.sti";
      break;
    case LOADINGSCREEN_NIGHTDESERT:
      filename = LOADSCREENSDIR "/ls_nightdesert.sti";
      break;
    case LOADINGSCREEN_NIGHTPALACE:
      filename = LOADSCREENSDIR "/ls_nightpalace.sti";
      break;
    case LOADINGSCREEN_HELI:
      filename = LOADSCREENSDIR "/ls_heli.sti";
      break;
    case LOADINGSCREEN_BASEMENT:
      filename = LOADSCREENSDIR "/ls_basement.sti";
      break;
    case LOADINGSCREEN_MINE:
      filename = LOADSCREENSDIR "/ls_mine.sti";
      break;
    case LOADINGSCREEN_CAVE:
      filename = LOADSCREENSDIR "/ls_cave.sti";
      break;
    case LOADINGSCREEN_DAYPINE:
      filename = LOADSCREENSDIR "/ls_daypine.sti";
      break;
    case LOADINGSCREEN_NIGHTPINE:
      filename = LOADSCREENSDIR "/ls_nightpine.sti";
      break;
    case LOADINGSCREEN_DAYMILITARY:
      filename = LOADSCREENSDIR "/ls_daymilitary.sti";
      break;
    case LOADINGSCREEN_NIGHTMILITARY:
      filename = LOADSCREENSDIR "/ls_nightmilitary.sti";
      break;
    case LOADINGSCREEN_DAYSAM:
      filename = LOADSCREENSDIR "/ls_daysam.sti";
      break;
    case LOADINGSCREEN_NIGHTSAM:
      filename = LOADSCREENSDIR "/ls_nightsam.sti";
      break;
    case LOADINGSCREEN_DAYPRISON:
      filename = LOADSCREENSDIR "/ls_dayprison.sti";
      break;
    case LOADINGSCREEN_NIGHTPRISON:
      filename = LOADSCREENSDIR "/ls_nightprison.sti";
      break;
    case LOADINGSCREEN_DAYHOSPITAL:
      filename = LOADSCREENSDIR "/ls_dayhospital.sti";
      break;
    case LOADINGSCREEN_NIGHTHOSPITAL:
      filename = LOADSCREENSDIR "/ls_nighthospital.sti";
      break;
    case LOADINGSCREEN_DAYAIRPORT:
      filename = LOADSCREENSDIR "/ls_dayairport.sti";
      break;
    case LOADINGSCREEN_NIGHTAIRPORT:
      filename = LOADSCREENSDIR "/ls_nightairport.sti";
      break;
    case LOADINGSCREEN_DAYLAB:
      filename = LOADSCREENSDIR "/ls_daylab.sti";
      break;
    case LOADINGSCREEN_NIGHTLAB:
      filename = LOADSCREENSDIR "/ls_nightlab.sti";
      break;
    case LOADINGSCREEN_DAYOMERTA:
      filename = LOADSCREENSDIR "/ls_dayomerta.sti";
      break;
    case LOADINGSCREEN_NIGHTOMERTA:
      filename = LOADSCREENSDIR "/ls_nightomerta.sti";
      break;
    case LOADINGSCREEN_DAYCHITZENA:
      filename = LOADSCREENSDIR "/ls_daychitzena.sti";
      break;
    case LOADINGSCREEN_NIGHTCHITZENA:
      filename = LOADSCREENSDIR "/ls_nightchitzena.sti";
      break;
    case LOADINGSCREEN_DAYMINE:
      filename = LOADSCREENSDIR "/ls_daymine.sti";
      break;
    case LOADINGSCREEN_NIGHTMINE:
      filename = LOADSCREENSDIR "/ls_nightmine.sti";
      break;
    case LOADINGSCREEN_DAYBALIME:
      filename = LOADSCREENSDIR "/ls_daybalime.sti";
      break;
    case LOADINGSCREEN_NIGHTBALIME:
      filename = LOADSCREENSDIR "/ls_nightbalime.sti";
      break;
    default:
      filename = LOADSCREENSDIR "/ls_heli.sti";
      break;
  ...
  } catch (...) {  // Failed to load the file, so use a black screen and print
                   // out message.
