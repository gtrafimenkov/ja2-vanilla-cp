...
// Sector enumerations
//
// NOTE: These use the 0-255 SectorInfo[] numbering system, and CAN'T be used as
// indexes into the StrategicMap[] array Use SECTOR_INFO_TO_STRATEGIC_INDEX()
// macro to convert...
enum {
  SEC_A1,
  SEC_A2,
...
enum {
  ...
  SAND_ROAD,
  SWAMP_ROAD,
  // only used for text purposes and not assigned to areas (SAM sites are hard
  // coded throughout the code)
...
// Used by ubGarrisonID when a sector doesn't point to a garrison.  Used by
// strategic AI only.
