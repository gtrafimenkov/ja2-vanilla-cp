...
// These define the macros for the 32 road pieces.  The column contains the
// macro ID and the second contains the gridno offset from the anchor position
// (where the user clicks in the world to place the road).  The actual index of
// the array refers to the offset from ROADPIECE001.
...
// The old road system used multi-tiled roads as a single image.  The new road
// system has taken these large pieces and chopped them up into single tiled
// images (to mitigate lighting problems).  Some of the larger road pieces turned
// into 18 smaller pieces.  So this function will go analyse the world, and
