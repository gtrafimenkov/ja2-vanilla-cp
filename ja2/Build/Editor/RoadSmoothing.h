...
// There are the 32 macro definitions that make up all of the road pieces. These
// enumerations match up exactly to the previous road system order of graphics
// (FIRSTROAD1 - FIRSTROAD32)
enum {
  ...
  BTR,  // bottom top-right corner piece (the bottom part of the top-right
        // corner)
