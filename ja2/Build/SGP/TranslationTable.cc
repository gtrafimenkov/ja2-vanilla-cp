...
CTranslationTable::CTranslationTable() { memset(m_table, 0, sizeof(m_table)); }
...
class CTranslationTableEnglish : public CTranslationTable {
 public:
  ...
  CTranslationTableEnglish() {
    ...
    m_table[0x042A] = 128;  // cyrillic capital hard sign, glyph is missing,
                            // mapped to soft sign
    ...
    m_table[0x044A] = 128;  // cyrillic lowercase hard sign, glyph is missing,
                            // mapped to soft sign
