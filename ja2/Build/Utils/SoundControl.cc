...
static char const *const szSoundEffects[NUM_SAMPLES] = {
    ...
    SOUNDSDIR "/weapons/7,62 wp single shot.wav",     //	S_DRAGUNOV			7.62
                                                      // WP
    SOUNDSDIR
    "/weapons/7,62 nato single shot.wav",          //	S_M24						7.62
                                                   // NATO
    ...
    SOUNDSDIR "/weapons/7,62 wp single shot.wav",  //	S_AKM
                                                   // 7.62mm WP
    SOUNDSDIR
    "/weapons/7,62 nato single shot.wav",  //	S_M14						7.62mm
                                           // NATO
    SOUNDSDIR
    "/weapons/7,62 nato single shot.wav",  //	S_FNFAL					7.62mm
                                           // NATO
    SOUNDSDIR
    "/weapons/7,62 nato single shot.wav",          //	S_G3A3					7.62mm
                                                   // NATO
