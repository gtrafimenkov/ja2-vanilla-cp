        ...
        szSoundEffects[NUM_SAMPLES] =
            {
                ...
                SOUNDSDIR "/weapons/5,7 single shot.wav",         //	S_P90
                                                                  // 5.7
                SOUNDSDIR
                "/weapons/7,62 wp single shot.wav",            //	S_TYPE85				7.62
                                                               // WP
                SOUNDSDIR "/weapons/7,62 wp single shot.wav",  //	S_SKS
                                                               // 7.62 WP
                SOUNDSDIR
                "/weapons/7,62 wp single shot.wav",              //	S_DRAGUNOV			7.62
                                                                 // WP
                ...
                SOUNDSDIR "/weapons/5,56 single shot.wav",       //	S_G41
                                                                 // 5.56mm
                SOUNDSDIR
                "/weapons/5,56 single shot.wav",                 //	S_RUGERMINI			5.56mm
                ...
                SOUNDSDIR
                "/weapons/auto resolve composite 02 (8-22).wav",  //  The FF sound in
...
void SetSpeechVolume(UINT32 uiNewVolume) { guiSpeechVolume = __min(uiNewVolume, MAXVOLUME); }
