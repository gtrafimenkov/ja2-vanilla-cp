...
always used in conjunction with other characters.  For example, %s means string,
...
static StrPointer s_eng_Message[Message_SIZE] = {
    ...
    L"The item you have in your cursor can be attached to certain items by "
    L"placing it in one of the four attachment slots.",
    L"The item you have in your cursor can be attached to certain items by "
    L"placing it in one of the four attachment slots. (However in this case, "
    L"the item is not compatible.)",
    ...
    L"I DON'T think so!",
    L"To travel in Skyrider's chopper, you'll have to ASSIGN mercs to "
    L"VEHICLE/HELICOPTER first.",
...
static const wchar_t *s_eng_gpStrategicString[gpStrategicString_SIZE] = {
    L"%ls have been detected in sector %c%d and another squad is about to "
    L"arrive.",  // STR_DETECTED_SINGULAR
    L"%ls have been detected in sector %c%d and other squads are about to "
    L"arrive.",                                            // STR_DETECTED_PLURAL
    ...
    L"|Retreat all groups to their previous sectors.",  // multiple groups with
    ...
    L"Enemies attack your mercs in sector %ls.  None of your mercs are able to "
    L"fight!",
    //%s is the sector location -- ex:  A9: Omerta
    L"Creatures attack your mercs in sector %ls.  None of your mercs are able "
    L"to fight!",
...
static const wchar_t *s_eng_gMoneyStatsDesc[gMoneyStatsDesc_SIZE] = {
    ...
    L"Amount",
    L"To Split:",  // the amount he wants to separate from the overall balance to
...
static StrPointer s_eng_zTalkMenuStrings[zTalkMenuStrings_SIZE] = {
    ...
    L"Threaten",     // approach threateningly - talk now, or I'll blow your face
                     // off
    L"Give",
    L"Recruit",
};
...
static StrPointer s_eng_TacticalStr[TacticalStr_SIZE] = {
    ...
    L"The lock has %ls.", L"There's no lock.", L"The lock isn't trapped.",
    // The %s is a merc name
    L"%ls doesn't have the right key.", L"The lock isn't trapped.", L"Locked.", L"DOOR", L"TRAPPED",
    L"LOCKED", L"UNLOCKED", L"SMASHED", L"There's a switch here.  Activate it?", L"Disarm trap?",
    L"More...",

    // In the next 2 strings, %s is an item name

    L"The %ls has been placed on the ground.", L"The %ls has been given to %ls.",

    // In the next 2 strings, %s is a name

    L"%ls has been paid in full.", L"%ls is still owed %d.",
    L"Choose detonation frequency:",     // in this case, frequency refers to a
                                         // radio signal
    L"How many turns 'til she blows:",   // how much time, in turns, until the
                                         // bomb blows
    L"Set remote detonator frequency:",  // in this case, frequency refers to a
                                         // radio signal
    L"Disarm boobytrap?", L"Remove blue flag?", L"Put blue flag here?", L"Ending Turn",

    // In the next string, %s is a name. Stance refers to way they are standing.

    L"You sure you want to attack %ls ?", L"Ah, vehicles can't change stance.",
    L"The robot can't change its stance.",

    // In the next 3 strings, %s is a name

    L"%ls can't change to that stance here.", L"%ls can't have first aid done here.",
    L"%ls doesn't need first aid.", L"Can't move there.",
    L"Your team's full. No room for a recruit.",  // there's no room for a
    ...
    L"Throw there? Not gonna happen.",  // Merc can't throw to the destination he
                                        // selected
    ...
    L"Mute off for %ls.", L"Mute on for %ls.", L"Health: %d/%d\nFuel: %d/%d", L"Exit Vehicle",
    ...
    L"Use ( Medkit )", L"(Catch)", L"(Reload)", L"(Give)", L"%ls has been set off.",
    L"%ls has arrived.", L"%ls ran out of Action Points.", L"%ls isn't available.",
    L"%ls is all bandaged.", L"%ls is out of bandages.", L"Enemy in sector!",
    L"No enemies in sight.", L"Not enough Action Points.", L"Nobody's using the remote.",
    L"Burst fire emptied the clip!", L"SOLDIER", L"CREPITUS", L"MILITIA", L"CIVILIAN",
    L"Exiting Sector", L"OK", L"Cancel", L"Selected Merc", L"All Mercs in Squad", L"Go to Sector",
    L"Go to Map", L"You can't leave the sector from this side.", L"%ls is too far away.",
    L"Removing Treetops", L"Showing Treetops",
    ...
    L"Path Blocked",
    L"Deposit/Withdraw Money",  // Help text over the $ button on the Single Merc
                                // Panel
    ...
    // (e.g. $200)
    L"Do you agree to pay %ls?", L"Accept free medical treatment?", L"Agree to marry Daryl?",
    ...
    L"Can't autobandage right now", L"Path Blocked for %ls",
...
static const wchar_t *s_eng_pExitingSectorHelpText[pExitingSectorHelpText_SIZE] = {
    ...
    L"If checked, the adjacent sector will be immediately "
    L"loaded.",
    L"If checked, you will be placed automatically in the map "
    ...
    L"This sector is enemy occupied and you can't leave mercs "
    L"here.\nYou must deal with this situation before loading "
    L"any other sectors.",
    ...
    L"adjacent sector will immediately be loaded.",
    L"By moving your remaining mercs out of this sector,\nyou "
    L"will be placed automatically in the map screen\nas it "
    L"will take time for your mercs to travel.",

    // If an EPC is the selected merc, it won't allow the merc
    // to leave alone as the merc is being escorted.  The
    // "single" button is disabled.
    L"%ls needs to be escorted by your mercs and cannot leave "
    L"this sector alone.",
    ...
    L"%ls cannot leave this sector alone as he is escorting "
    L"%ls.",  // male singular
    L"%ls cannot leave this sector alone as she is escorting "
    L"%ls.",  // female singular
    L"%ls cannot leave this sector alone as he is escorting "
    L"multiple characters.",  // male plural
    L"%ls cannot leave this sector alone as she is escorting "
    L"multiple characters.",  // female plural

    // If one or more of your mercs in the selected squad aren't
    // in range of the traversal area, then the  "move all"
    // option is disabled, and this helptext explains why.
    L"All of your mercs must be in the vicinity\nin order to "
    L"allow the squad to traverse.",

    // Standard helptext for single movement.  Explains what
    // will happen (splitting the squad)
    L"If checked, %ls will travel alone, and\nautomatically "
    L"get reassigned to a unique squad.",

    // Standard helptext for all movement.  Explains what will
    // happen (moving the squad)
    L"If checked, your currently selected\nsquad will travel, "
    L"leaving this sector.",
    ...
    // interface will not appear.  This is just like the
    // situation where This string is special, as it is not used
    // as helptext.  Do not use the special newline character
    // (\n) for this string.
    L"%ls is being escorted by your mercs and cannot leave "
    L"this sector alone. Your other mercs must be nearby "
    L"before you can leave.",
};

static const wchar_t *s_eng_pRepairStrings[pRepairStrings_SIZE] = {
    L"Items",     // tell merc to repair items in inventory
    L"SAM Site",  // tell merc to repair SAM site - SAM is an acronym for Surface
                  // to Air Missile
    L"Cancel",    // cancel this menu
...
static const wchar_t *s_eng_pHelicopterEtaStrings[pHelicopterEtaStrings_SIZE] = {
    ...
    L"Helicopter is low on fuel and must land in hostile "
    L"territory!",  // warning that the sector the helicopter is
                    // going to use for refueling is under enemy
                    // control ->
    L"Passengers: ",
...
static const wchar_t s_eng_sMapLevelString[] = L"Sublevel:";  // what level below the ground is the
                                                              // player viewing in mapscreen

static const wchar_t s_eng_gsLoyalString[] =
    L"%d%% Loyal";  // the loyalty rating of a town ie : Loyal 53%
...
static const wchar_t *s_eng_pUpdateMercStrings[pUpdateMercStrings_SIZE] = {
    ...
    L"Mercs Contract Expired:",      // this pop up came up due to a merc contract
                                     // ending
    L"Mercs Completed Assignment:",  // this pop up....due to more than one merc
                                     // finishing assignments
    L"Mercs Back on the Job:",       // this pop up ....due to more than one merc
                                     // waking up and returing to work
    L"Mercs Catching Some Z's:",     // this pop up ....due to more than one merc
                                     // being tired and going to sleep
    L"Contracts Expiring Soon:",     // this pop up came up due to a merc contract
                                     // ending
};
...
static const wchar_t s_eng_pFinanceTitle[] = L"Bookkeeper Plus";  // the name we made up for the
...
static const wchar_t *s_eng_pTransactionText[pTransactionText_SIZE] = {
    ...
    L"IMP Profile Analysis",     // IMP is the acronym for International Mercenary
                                 // Profiling
    ...
    L"Purchased items from %ls.",  // is used for the Shop keeper interface.  The
...
static const wchar_t *s_eng_pSkyriderText[pSkyriderText_SIZE] = {
    ...
    L"Skyrider has no passengers.  If it is your intention to transport mercs "
    L"in this sector, assign them to Vehicle/Helicopter first.",
};
...
static const wchar_t s_eng_str_left_equipment[] =
    L"%ls's equipment is now available in %ls (%c%d).";
...
static const wchar_t
    *s_eng_pMapScreenPrevNextCharButtonHelpText[pMapScreenPrevNextCharButtonHelpText_SIZE] = {
        L"Previous Merc (|L|e|f|t)",  // previous merc in the list
        L"Next Merc (|R|i|g|h|t)",    // next merc in the list
};

static const wchar_t s_eng_pEtaString[] =
    L"ETA:";  // eta is an acronym for Estimated Time of Arrival

static const wchar_t *s_eng_pTrashItemText[pTrashItemText_SIZE] = {
    L"You'll never see it again. You sure?",  // do you want to continue and lose
                                              // the item forever
    L"This item looks REALLY important. Are you REALLY REALLY sure you want to "
    L"trash it?",  // does the user REALLY want to trash this item
};
...
static const wchar_t *s_eng_pMapErrorString[pMapErrorString_SIZE] = {
    ...
    L"You don't have any team members yet.",  // you have no members, can't do
                                              // anything
    L"Merc can't comply.",                    // merc can't comply with your order
                                              // 6-10
    L"%ls needs an escort to move. Place him on a squad with one.",  // merc
                                                                     // can't
                                                                     // move
                                                                     // unescorted
                                                                     // .. for a
                                                                     // male
    L"%ls needs an escort to move. Place her on a squad with one.",  // for a
                                                                     // female
    ...
    // 16-20
    L"The mine in %ls has been taken over. Your daily income has been reduced "
    L"to %ls per day.",
    ...
    L"Militia that are not within town boundaries cannot be moved to another "
    L"sector.",
    // 31-35
    ...
    L"The robot can't move without its controller. Place them together in the "
    L"same squad.",
};

// help text used during strategic route plotting
static const wchar_t *s_eng_pMapPlotStrings[pMapPlotStrings_SIZE] = {
    L"Click again on the destination to confirm your final route, or click on "
    L"another sector to place more waypoints.",
...
static const wchar_t
    *s_eng_pMiscMapScreenMouseRegionHelpText[pMiscMapScreenMouseRegionHelpText_SIZE] = {
        L"Enter Inventory (|E|n|t|e|r)",
        L"Throw Item Away",
        L"Exit Inventory (|E|n|t|e|r)",
};

static const wchar_t s_eng_str_he_leaves_where_drop_equipment[] =
    L"Have %ls leave his equipment where he is now (%ls) or later on in %ls "
    L"(%ls) upon catching flight out of Arulco?";
static const wchar_t s_eng_str_she_leaves_where_drop_equipment[] =
    L"Have %ls leave her equipment where she is now (%ls) or later on in %ls "
    L"(%ls) upon catching flight out of Arulco?";
static const wchar_t s_eng_str_he_leaves_drops_equipment[] =
    L"%ls is about to leave and will drop off his equipment in %ls.";
static const wchar_t s_eng_str_she_leaves_drops_equipment[] =
...
static const wchar_t *s_eng_pImpPopUpStrings[pImpPopUpStrings_SIZE] = {
    ...
    L"Preliminary analysis of your financial status shows that you cannot "
    L"afford a profile analysis.",
    L"Not A Valid Option At This Time.",
    L"To complete an accurate profile, you must have room for at least one "
    L"team member.",
...
static const wchar_t *s_eng_pImpButtonText[pImpButtonText_SIZE] = {
    ...
    L"NO, I WANT TO START OVER.",  // no, I want to start over the profiling
                                   // process
    L"YES, I DO.",
    L"NO",
...
static const wchar_t *s_eng_pFilesSenderList[pFilesSenderList_SIZE] = {
    L"Recon Report",  // the recon report sent to the player. Recon is an
...
static const wchar_t s_eng_pErrorStrings[] =
...
static const wchar_t s_eng_pWebTitle[] = L"sir-FER 4.0";  // our name for the version of the
...
static const wchar_t *s_eng_pPersonnelDepartedStateStrings[pPersonnelDepartedStateStrings_SIZE] = {
    ...
    L"Killed in Action", L"Dismissed", L"Married", L"Contract Expired", L"Quit",
};
...
static const wchar_t
    *s_eng_pPersonnelCurrentTeamStatsStrings[pPersonnelCurrentTeamStatsStrings_SIZE] = {
        L"Lowest",
        L"Average",
        L"Highest",
};
...
static StrPointer s_eng_LargeTacticalStr[LargeTacticalStr_SIZE] = {
    ...
    L"The enemy, having no mercy for the team's soul, devours each and every "
    L"one of you!",
...
static const wchar_t *s_eng_MercAccountText[MercAccountText_SIZE] = {
    ...
    L"Charge",
    L"Total:",
    L"Are you sure you want to authorize the payment of %ls?",  // the %s is a
                                                                // string that
                                                                // contains the
                                                                // dollar amount (
                                                                // ex. "$150" )
...
static const wchar_t *s_eng_sFuneralString[sFuneralString_SIZE] = {
    ...
    L"Funeral Director and former A.I.M. mercenary Murray \"Pops\" "
    L"McGillicutty is a highly skilled and experienced mortician.",
    L"Having been intimately involved in death and bereavement throughout his "
    L"life, Pops knows how difficult it can be.",
    L"McGillicutty's Mortuary offers a wide range of bereavement services, "
    L"from a shoulder to cry on to post-mortem reconstruction for badly "
    L"disfigured remains.",
    ...
    // send flowers ).
    L"Regretably, the remainder of this site has not been completed due to a "
    L"death in the family. Pending reading of the will and disbursement of "
    L"assets, the site will be completed as soon as possible.",
    L"Our sympathies do, however, go out to you at this trying time.  Please "
    L"come again.",
};
...
static const wchar_t *s_eng_sFloristText[sFloristText_SIZE] = {
    ...
    L"Next day delivery to most areas worldwide, guaranteed.  Some "
    L"restrictions apply.",
    L"Lowest prices in the world, guaranteed!",
    L"Show us a lower advertised price for any arrangements, and receive a "
    L"dozen roses, absolutely free.",
    L"Flying Flora, Fauna & Flowers Since 1981.",
    L"Our decorated ex-bomber aviators will air-drop your bouquet within a ten "
    L"mile radius of the requested location.  Anytime - Everytime!",
    L"Let us satisfy your floral fantasy.",
    L"Let Bruce, our world-renowned floral designer, hand-pick the freshest, "
    L"highest quality flowers from our very own greenhouse.",
...
static const wchar_t *s_eng_sOrderFormText[sOrderFormText_SIZE] = {
    ...
    L"Due to the size of gift cards, your message can be no longer than 75 "
    L"characters.",
...
static const wchar_t *s_eng_sFloristGalleryText[sFloristGalleryText_SIZE] = {
    ...
    L"Please Note: there is an additional $10 fee for all wilted or crushed "
    L"bouquets.",
...
static const wchar_t *s_eng_BobbyROrderFormText[BobbyROrderFormText_SIZE] = {
    ...
    L"Grand Total",              // The grand total of all item totals + the shipping and
                                 // handling
    L"Delivery Location",
    ...
    L"You can't afford to pay for this.",  // 20	// A popup message that to warn
                                           // of not enough money
    L"<NONE>",                             // Gets displayed when there is no valid city selected
    L"Are you sure you want to send this order to %ls?",  // A popup that asks if
                                                          // the city selected is
                                                          // the correct one
    L"Package Weight**",                                  // Displays the weight of the package
    L"** Min. Wt.",  // Disclaimer states that there is a minimum weight for the
                     // package
    L"Shipments",
};
...
static const wchar_t *s_eng_BobbyRText[BobbyRText_SIZE] = {
    ...
    L"Click on the item(s). For more than one, keep on clicking. Right click "
    L"for less. Once you've selected all you'd like to buy, go on to the order "
    L"form.",
    ...
    L"* % Functional",  // if the item is damaged, displays the percent function
                        // of the item

    // Popup that tells the player that they can only order 10 items at a time

    L"Darn!  This here on-line order form will only accept 10 items per order. "
    L" If you're looking to order more stuff (and we hope you are), kindly "
    L"make a separate order and accept our apologies.",

    // A popup that tells the user that they are trying to order more items then
    // the store has in stock

    L"Sorry. We don't have any more of that in stock right now. Please try "
    L"again later.",
 ...
 * ammo. */
static const wchar_t s_eng_str_bobbyr_guns_num_guns_that_use_ammo[] =
    L"Your team has %d weapon(s) that use this type of ammo";
...
static const wchar_t *s_eng_BobbyRaysFrontText[BobbyRaysFrontText_SIZE] = {
    ...
    L"This is the place to be for the newest and hottest in weaponry and "
    L"military supplies",
...
static const wchar_t *s_eng_AimSortText[AimSortText_SIZE] = {
    ...
    L"View the mercenary mug shot index", L"Review the individual mercenary's file",
...
static const wchar_t *s_eng_CharacterInfo[CharacterInfo_SIZE] = {
    ...
    L"MEDICAL deposit required",  // If the merc required a medical deposit, this
                                  // is displayed
};
...
static const wchar_t *s_eng_VideoConfercingText[VideoConfercingText_SIZE] = {
    ...
    L"with medical"  // Displays if you are hiring the merc with the medical
                     // deposit
};
...
static const wchar_t *s_eng_AimPopUpText[AimPopUpText_SIZE] = {
    ...
    L"UNABLE TO PROCESS TRANSFER",            // Player doesn't have enough money, message
                                              // 1
...
static const wchar_t *s_eng_SKI_Text[SKI_SIZE] = {
    ...
    L"TOTAL COST",            // The total cost of the the items in the Dealer inventory
                              // area
    L"TOTAL VALUE",           // The total value of items player wishes to sell
    L"EVALUATE",              // Button text for dealer to evaluate items the player wants to
                              // sell
    ...
    L"REPAIR COST",           // The amount the dealer will charge to repair the merc's
                              // goods
    L"1 HOUR",                // SINGULAR! The text underneath the inventory slot when an item
                              // is given to the dealer to be repaired
    L"%d HOURS",              // PLURAL!   The text underneath the inventory slot when an
                              // item is given to the dealer to be repaired
    L"REPAIRED",              // Text appearing over an item that has just been repaired by a
                              // NPC repairman dealer
    L"There is not enough room in your offer area.",  // Message box that tells
                                                      // the user there is no more
                                                      // room to put there stuff
...
static const wchar_t *s_eng_SkiMessageBoxText[SkiMessageBoxText_SIZE] = {
    L"Do you want to deduct %ls from your main account to cover the "
    L"difference?",
...
static const wchar_t *s_eng_zSaveLoadText[zSaveLoadText_SIZE] = {
    ...
    L"The game version in the saved game file is different then the current "
    L"version.  It is most likely safe to continue.  Continue?",
    ...
    L"You are running low on disk space.  You only have %d Megs free and "
    L"Jagged should have at least %d Megs free.",

    L"Saving...",  // When saving a game, a message box with this string appears
                   // on the screen
...
static const wchar_t *s_eng_zMarksMapScreenText[zMarksMapScreenText_SIZE] = {
    L"Map Level",
    L"You have no militia.  You need to train town residents in order to have "
    L"a town militia.",
    L"Daily Income",
    ...
    // stuff for contracts
    L"While you can pay for the contract, you don't have the bucks to cover "
    L"this merc's life insurance premium.",
    L"%ls insurance premium will cost %ls for %d extra day(s). Do you want to "
    L"pay?",
    L"Sector Inventory",
...
static const wchar_t s_eng_pLandMarkInSectorString[] =
    L"Squad %d has noticed someone in sector %ls";

// confirm the player wants to pay X dollars to build a militia force in town
static const wchar_t *s_eng_pMilitiaConfirmStrings[pMilitiaConfirmStrings_SIZE] = {
    L"Training a squad of town militia will cost $",  // telling player how
                                                      // much it will cost
    L"Approve expenditure?",                        // asking player if they wish to pay the amount
                                                    // requested
    L"You can't afford it.",                        // telling the player they can't afford to
                                                    // train this town
    L"Continue training militia in %ls (%ls %d)?",  // continue training this
                                                    // town?
    L"Cost $",                                      // the cost in dollars to train militia
    L"( Y/N )",                                     // abbreviated yes/no
    L"Training town militia in %d sectors will cost $ %d. %ls",  // cost to
                                                                 // train
                                                                 // sveral
                                                                 // sectors
                                                                 // at once
    L"You cannot afford the $%d to train town militia here.",
    L"%ls needs a loyalty of %d percent for you to be able to continue "
    L"training militia.",
...
static const wchar_t s_eng_gzCopyrightText[] =
...
static const wchar_t *s_eng_zOptionsScreenHelpText[zOptionsToggleText_SIZE] = {
    ...
    L"If Subtitles are ON, turn this on also to be able to take your time "
    L"reading NPC dialogue.",

    // Toggle smoke animation
    L"Turn off this option if animating smoke slows down your game's "
    L"framerate.",
    ...
    // Never move my mouse
    L"Turn this option OFF to have your mouse automatically move over pop-up "
    L"confirmation boxes when they appear.",

    // Old selection method
    L"Turn this ON for character selection to work as in previous JAGGED "
    L"ALLIANCE games (which is the opposite of how it works otherwise).",

    // Show movement path
    L"Turn this ON to display movement paths in Real-time (or leave it off and "
    L"use the SHIFT key when you do want them displayed).",

    // show misses
    L"Turn ON to have the game show you where your bullets ended up when you "
    L"\"miss\".",

    // Real Time Confirmation
    L"When ON, an additional \"safety\" click will be required for movement in "
    L"Real-time.",

    // Sleep/Wake notification
    L"When ON, you will be notified when mercs on \"assignment\" go to sleep "
    L"and resume work.",

    // Use the metric system
    L"When ON, uses the metric system for measurements; otherwise it uses the "
    L"Imperial system.",

    // Merc Lighted movement
    L"When ON, the merc will light the ground while walking.  Turn OFF for "
    L"faster frame rate.",

    // Smart cursor
    L"When ON, moving the cursor near your mercs will automatically highlight "
    L"them.",

    // snap cursor to the door
    L"When ON, moving the cursor near a door will automatically position the "
    L"cursor over the door.",
...
static const wchar_t *s_eng_gzGIOScreenText[gzGIOScreenText_SIZE] = {L"INITIAL GAME SETTINGS",
                                                                     L"Game Style",
                                                                     L"Realistic",
                                                                     L"Sci Fi",
                                                                     L"Gun Options",
...
static const wchar_t s_eng_pSkillAtZeroWarning[] =
...
static const wchar_t *s_eng_pMessageStrings[pMessageStrings_SIZE] = {
    ...
    L"%ls has arrived in sector %ls%ls",  // Name/Squad has arrived in sector A9.
                                          // Order must not change without
                                          // notifying SirTech
    L"Version",
    L"Empty Quick Save Slot",
    L"This slot is reserved for Quick Saves made from the tactical and map "
    L"screens using ALT+S.",
    L"Opened",
    L"Closed",
    L"You are running low on disk space.  You only have %lsMB free and Jagged "
    L"Alliance 2 requires %lsMB.",
    L"%ls has caught %ls.",       //'Merc name' has caught 'item' -- let SirTech know
                                  // if name comes after item.
    ...
    L"%ls passed to %ls.",           //"Item" passed to "merc".  Please try to keep the
                                     // item %s before the merc %s, otherwise, must notify
                                     // SirTech.
    L"No room to pass %ls to %ls.",  // pass "item" to "merc".  Same instructions
                                     // as above.
    ...
    L"3D Cursor ON.",
    L"Squad %d active.",
    L"You cannot afford to pay for %ls's daily salary of %ls",  // first %s is
                                                                // the mercs name,
                                                                // the seconds is
                                                                // a string
                                                                // containing the
    ...
    L"A save has been created called, SaveGame99.sav.  If needed, rename it to "
    L"SaveGame01 - SaveGame10 and then you will have access to it in the Load "
    L"screen.",
    L"%ls drank some %ls",
    L"A package has arrived in Drassen.",
    L"%ls should arrive at the designated drop-off point (sector %ls) on day "
    L"%d, at approximately %ls.",  // first %s is mercs name, next is the sector
                                   // location and name where they will be
                                   // arriving in, lastely is the day an the time
                                   // of arrival
...
static const wchar_t *s_eng_pMilitiaButtonsHelpText[pMilitiaButtonsHelpText_SIZE] = {
    L"Pick up(Right Click)/drop(Left Click) Green Troops",  // button help
                                                            // text informing
                                                            // player they
                                                            // can pick up or
                                                            // drop militia
...
static const wchar_t s_eng_pMapScreenJustStartedHelpText[] =
    L"Go to AIM and hire some mercs ( *Hint* it's in the Laptop )";

static const wchar_t s_eng_pAntiHackerString[] =
...
static const wchar_t *s_eng_gzNonPersistantPBIText[gzNonPersistantPBIText_SIZE] = {
    L"There is a battle in progress. You can only retreat from the "
    L"tactical screen.",
    ...
    L"You can't automatically resolve a battle while you are being "
    L"ambushed.",
    L"You can't automatically resolve a battle while you are fighting "
    L"creatures in the mines.",
    L"You can't automatically resolve a battle while there are hostile "
    L"civilians.",
...
static const wchar_t *s_eng_zGioDifConfirmText[zGioDifConfirmText_SIZE] = {
    ...
    L"to Jagged Alliance, those new to strategy games in general, or those "
    L"wishing shorter battles in the game. Your choice will affect things "
    L"throughout the entire course of the game, so choose wisely. Are you sure "
    L"you want to play in Novice mode?",
    L"You have chosen EXPERIENCED mode. This setting is suitable for those "
    L"already familiar with Jagged Alliance or similar games. Your choice will "
    L"affect things throughout the entire course of the game, so choose "
    L"wisely. Are you sure you want to play in Experienced mode?",
    L"You have chosen EXPERT mode. We warned you. Don't blame us if you get "
    L"shipped back in a body bag. Your choice will affect things throughout "
    L"the entire course of the game, so choose wisely. Are you sure you want "
    L"to play in Expert mode?",
};

static const wchar_t *s_eng_gzLateLocalizedString[gzLateLocalizedString_SIZE] = {
    // 1-5
    L"The robot cannot leave this sector when nobody is using the "
    L"controller.",
    ...
    L"%ls does not need immediate first aid or bandaging but rather more "
    L"serious medical attention and/or rest.",
    ...
    L"It is currently unsafe to compress time because you have mercs in "
    L"sector %ls.",
    L"It is currently unsafe to compress time when mercs are in the "
    L"creature infested mines.",
    ...
    // 39
    L"None of your remaining mercs are able to fight.  The militia will "
    L"fight the creatures on their own.",
...
static const wchar_t s_eng_str_ceramic_plates_smashed[] =
    L"%ls's ceramic plates have been smashed!";

static const wchar_t s_eng_str_arrival_rerouted[] =
    L"Arrival of new recruits is being rerouted to sector %ls, as scheduled "
    L"drop-off point of sector %ls is enemy occupied.";
...
static const wchar_t *s_eng_str_stat_list[str_stat_list_SIZE] = {
    s_eng_str_stat_health,    s_eng_str_stat_agility,      s_eng_str_stat_dexterity,
    s_eng_str_stat_strength,  s_eng_str_stat_leadership,   s_eng_str_stat_wisdom,
    s_eng_str_stat_exp_level, s_eng_str_stat_marksmanship, s_eng_str_stat_mechanical,
    s_eng_str_stat_explosive, s_eng_str_stat_medical};

static const wchar_t *s_eng_str_aim_sort_list[str_aim_sort_list_SIZE] = {
    s_eng_str_aim_sort_price,     s_eng_str_aim_sort_experience, s_eng_str_aim_sort_marksmanship,
    s_eng_str_aim_sort_medical,   s_eng_str_aim_sort_explosives, s_eng_str_aim_sort_mechanical,
    s_eng_str_aim_sort_ascending, s_eng_str_aim_sort_descending,
};
...
const wchar_t *g_eng_str_iron_man_mode_warning =
